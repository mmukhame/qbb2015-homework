...
bedA = arr.copy()
bedA.set_bits_from_file(sys.argv[2])
bedB = arr.copy()
bedB.set_bits_from_file(sys.argv[3])
arrC = bedA.intersect(bedB.complement())
print arrC.arrays
...
B = 00000001111011111100
B'= 11111110000100000011
A = 00011111000101000111
I = 00011110000100000011
